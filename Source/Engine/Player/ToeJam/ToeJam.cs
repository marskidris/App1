...
namespace App1.Source.Engine.Player.ToeJam
{
    public class ToeJam : ICharacterFrames
    {
        ...
        private void ToeJamFrames()
        {
            ...
            playerFramesW[0] = new Rectangle(22, 132, 27, 31);
            playerFramesW[1] = new Rectangle(62, 133, 21, 30);
            playerFramesW[2] = new Rectangle(93, 131, 24, 32);
            playerFramesW[3] = new Rectangle(125, 131, 27, 32);
            playerFramesW[4] = new Rectangle(160, 133, 22, 30);
            playerFramesW[5] = new Rectangle(190, 133, 22, 30);
